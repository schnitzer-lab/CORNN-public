...
labels_all = ["CoRNN","Gradient descent - CE (GPU)", \
...
plt.savefig("FigureS2a.pdf", bbox_inches='tight')
...
plt.savefig("FigureS2b.pdf", bbox_inches='tight')