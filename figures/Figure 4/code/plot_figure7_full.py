...
plt.ylabel('Neuron ID')
plt.colorbar()
plt.savefig('Figure 7D1.pdf', bbox_inches='tight')
plt.show()
...
plt.xlabel('Time (ms)')
plt.ylabel('Input/output (a.u.)')
plt.savefig('Figure 7D2.pdf', bbox_inches='tight')
plt.show()
...
#%% Figures 7F-G, sub network
f = np.load('fig7_sub500_cornn_data.npz')
w = f['w']
w_out = f['w_out']
n_sup = 500;
alph = 0.1
...
plt.ylabel('Neuron ID')
plt.colorbar()
plt.savefig('Figure 7F1.pdf', bbox_inches='tight')
plt.show()
...
plt.xlabel('Time (ms)')
plt.ylabel('Input/output (a.u.)')
plt.savefig('Figure 7F2.pdf', bbox_inches='tight')
plt.show()
...
plt.ylabel('W$_{out}^{CoRNN}$')
plt.tight_layout()
plt.savefig('Figure 7G.pdf', bbox_inches='tight')
plt.show()

#%% Figures 7H-I, sub network
...
plt.ylabel('Neuron ID')
plt.colorbar()
plt.savefig('Figure 7H1.pdf', bbox_inches='tight')
plt.show()
...
plt.xlabel('Time (ms)')
plt.ylabel('Input/output (a.u.)')
plt.savefig('Figure 7H2.pdf', bbox_inches='tight')
plt.show()
...
plt.ylabel('W$_{out}^{CoRNN}$')
plt.tight_layout()
plt.savefig('Figure 7I.pdf', bbox_inches='tight')
plt.show()